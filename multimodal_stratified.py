    ...
    def train(self, train_loader: DataLoader, val_loader: DataLoader) -> Dict[str, Any]:
        ...
        for epoch in range(self.config.training.num_epochs):
            ...
            if val_loss < self.best_val_loss:
                ...
                # Save best model
                model_path = os.path.join(self.config.data.output_dir, 'models', 'best_multimodal.pth')
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="multi_modal_stratified", help="Output directory")
    ...
    try:
        ...
        # Initialize trainer
        trainer = MultiModalTrainer(config, logger)
